...
const SinglePassengerForm = () => {
  ...
  const { updatePassengersLoading } = useSelector(sessionSelector);
  ...
  const handleSubmit = async (values, { setSubmitting }) => {
    ...
    dispatch(updateSinglePassenger(passengerDetails));
  ...
  return (
    <form className="passenger__form" onSubmit={formik.handleSubmit} id="form">
      {/* Passenger Details */}
      <div className="passenger__form__box">
        <h3 className="font font-header font-bold text-xxs mb-4">ADULT</h3>

        <div className="mb-6 flex flex-wrap">
          <div className="form-group select-group mr-0 md:mr-4">
            <label>TITLE</label>
            <select id="title" name="title" {...formik.getFieldProps("title")}>
          ...
          <div className="form-group mr-0 md:mr-4">
            ...
            {formik.touched.firstName && formik.errors.firstName ? (
              <p className="errorText mt-2">{formik.errors.firstName}</p>
            ) : null}
          </div>
          <div className="form-group mr-0 md:mr-4">
            ...
            <div className="flex items-center mb-5">
              <Checkbox onChange={onChange}>
                <label className="check-label">
                  <span>Wheelchair</span> - Customer can climb stairs, Walk to &
                  from seat but unable to walk long distances, Requires
      ...
      <div className="passenger__form__box">
        ...
        >
          <Checkbox onChange={onCopyChange}>
            <label className="check-label">Copy Passenger Information</label>
          </Checkbox>
        </div>
        ...
        <div className="mb-6 flex flex-wrap">
          ...
          <div className="form-group md:mr-4">
            ...
            {formik.touched.c_firstName && formik.errors.c_firstName ? (
              <p className="errorText mt-2">{formik.errors.c_firstName}</p>
            ) : null}
          </div>
          <div className="form-group md:mr-4">
            <label>LAST NAME</label>
            ...
            {formik.touched.c_lastName && formik.errors.c_lastName ? (
              <p className="errorText mt-2">{formik.errors.c_lastName}</p>
            ) : null}
          </div>
          <div className="form-group md:mr-4">
            <label>EMAIL</label>
          ...
          <div className="phone-group  mr-0 md:mr-4">
            ...
            <div className="flex">
              <div className="phone-select">
                <select name="c_code" {...formik.getFieldProps("c_code")}>
