...
const ManageBookingTab = ({ type, promocode }) => {
  ...
  const formik = useFormik({
    initialValues: {
      origin: tripParams?.departureStation,
      destination: tripParams?.arrivalStation,
      departure: new Date(tripParams?.beginDate),
      return: tripParams?.isRoundTrip
        ? new Date(returnParams?.returnDate)
        : add(new Date(tripParams?.beginDate), { days: 7 }),
      promocode,
    },
    ...
    onSubmit: async (values) => {
      ...
      if (tripParams?.isRoundTrip) {
        ...
        // const check = isAfter(returnDate, departureDate);
            ...
            >
              ...
              <div className="w-full mx-2 px-2 md:px-0">
                ...
                <Select
                  ...
                  id="from"
                  instanceId="from"
                  placeholder={tripParams?.departureStation}
                  formatOptionLabel={formatOptionLabel}
                  components={{ Option }}
                  name="origin"
                  defaultValue={tripParams?.departureStation}
                  value={tripParams?.departureStation}
                  onChange={(value) => (
            ...
            >
              ...
              <div className="w-full mx-2 px-2 md:px-0">
                ...
                <Select
                  ...
                  placeholder={tripParams?.arrivalStation}
                  formatOptionLabel={formatOptionLabel}
                  components={{ Option }}
                  options={arrivals}
                  ...
                  styles={colourStyles}
                  name="destination"
                  defaultValue={tripParams?.arrivalStation}
                  value={tripParams?.arrivalStation}
                  onChange={(value) => {
