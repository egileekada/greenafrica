          ...
          <section className="ga__section">
            <div className="ga__section__main">
              <div className="mb-8 mt-16 xlg:mt-0">
                ...
                <p>
                  Thank you for booking your travel wIth Green Africa. Below is
                  a summary of your{" "}
                  <span className="font-display">One way</span> trip to{" "}
                  <span className="font-display">Abuja</span>. We’ve also sent a
                  copy of your booking confirmation to your email address.{" "}
                </p>
              </div>
