  ...
  const handleSell = async () => {
    ...
    dispatch(
      saveSellRequest({
        ...
        fareKey:
          _asssocaitedFare.length > 0 ? _asssocaitedFare[0]?.FareSellKey : "",
      })
    );
  };
              ...
              selectedSessionJourney.map((_journey) => {
                ...
                const fare_name =
                  _asssocaitedFare.length > 0
                    ? _asssocaitedFare[0]?.RuleNumber?.toLowerCase() === "flex"
                      ? "gFlex"
                      ...
                      <div className="flex flex-col my-6">
                        <div className="flex mb-6">
                          ...
                          <p>
                            ...
                            I acknowledge that personal information relating to
                            my booking may be accessible to government
